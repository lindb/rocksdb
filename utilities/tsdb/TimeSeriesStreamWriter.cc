...
namespace rocksdb {
    class TimeSeriesStreamWriterImpl : public TimeSeriesStreamWriter {
    private:
        std::string *data_;
        ...
        char cur_ = 0;
    public:
        TimeSeriesStreamWriterImpl(std::string *data) {
            data_ = data;
        }

        ~TimeSeriesStreamWriterImpl() {

        }

        void append(uint16_t timestamp, int64_t value) override {
         ...
         */
        void appendTimestamp(uint16_t timestamp) override {
            if (count_ == 0) {
        ...
        /**
          ...
          */
        void appendValue(int64_t value) override {
    ...
    TimeSeriesStreamWriter *NewTimeSeriesStreamWriter(std::string *data) {
        return new TimeSeriesStreamWriterImpl(data);
    }
}