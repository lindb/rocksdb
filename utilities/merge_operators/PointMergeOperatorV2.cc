...
//        } else {
//            if (!existing_value->starts_with(value)) {
//                Log(InfoLogLevel::ERROR_LEVEL, logger, "merge size %d %d \n%s\n%s", existing_value->size(), value.size(),
//                    existing_value->ToString(true).data(), value.ToString(true).data());
//            }
//            new_value->assign(value.data(), value.size());
...
//
//            Log(InfoLogLevel::ERROR_LEVEL, logger, "merge size %d %d \n%s\n%s\n%s\n%s", existing_value->size(), value.size(),
//                old_slice.ToString(true).data(), cur_slice.ToString(true).data(),
//                existing_value->ToString(true).data(), value.ToString(true).data());
//            char old_op = -1;
//            char new_op = -1;
...
//                    "loop1 %d %d %d %d %d %d\n%s\n%s", old_slice.size(), cur_slice.size(), old_op, new_op,
//                    old_point_len, new_point_len, old_slice.ToString(true).data(), cur_slice.ToString(true).data());
//
//                if (old_op == new_op) {
//                    std::string points = "";
...
//                        Log(InfoLogLevel::ERROR_LEVEL, logger,
//                            "loop 2 old enter op==new op %d %d %d %d %d %d %d", old_op, old_slot, new_slot, old_val, new_val,
//                            old_slice.size(),
//                            cur_slice.size());
